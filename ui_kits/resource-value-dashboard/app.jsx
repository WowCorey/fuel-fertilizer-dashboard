...
function App() {
  ...
  if (!data) {
    return (
      <div className="page">
        <Header active="resource_value" refreshStatus={refreshStatus}/>
  ...
  return (
    <div className="page">
      <Header active="resource_value" refreshStatus={refreshStatus} updated={latestRetrieved ? updatedDisplay : ''}/>

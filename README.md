...
| [AU economics](ui_kits/au-economics-dashboard/index.html) | v1.2 | RBA cash rate, household and government debt, mortgages, unemployment and inflation, plus a state/territory debt summary (4/8 verified) | RBA cash rate (F1.1), household debt-to-income (E2), standard variable mortgage rate (F5), credit-card balances accruing interest (C1.1), ABS real GDP growth, unemployment and CPI load from verified RBA/ABS endpoints; AOFM AGS face value is hand-keyed from official stock_ags.csv; state-level net debt now has 4 of 8 jurisdiction values verified from official Budget Paper PDFs downloaded during the Pass 2B value-entry pass: NSW A$120.3b GGS (BP1 Ch.8 Table 8.1), VIC A$167.6b GGS (Strategy and Outlook), QLD A$41.8b GGS (BP2 Balance Sheet), and WA A$39.0b Total Public Sector (BP3 Table 2; Partial coverage because WA's headline measure is TPS not GGS). SA, TAS, ACT and NT remain Partial coverage with null values (Treasury homepages returned HTTP 403/503). No national aggregate is published. |

...
| [Resource value](ui_kits/resource-value-dashboard/index.html) | v1.5 | Company tax, PRRT, petroleum royalties, LNG/oil export value, gas origin, export destinations and Norway comparison | Official policy/export envelopes hand-keyed; domestic-vs-export price comparison, state/basin flow mapping and value-leakage estimate remain unavailable until a documented method exists |
